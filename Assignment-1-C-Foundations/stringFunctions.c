/*
 * Program to implement various string functions present in string.h header file.
 * Command for Compilation -> gcc -o stringFunctions stringFunctions.c
 * Command for Execution -> ./stringFunctions
...
// parameters - char* s: first string, char* t: second string, int n: number of characters to be copied
// return - void
...
// parameter - char* s: first string, char* t: second string, int n: number of characters to be concatenate
// return - void
...
// parameters - char* s: first string, char* t: second string, int n: number of characters to be compared
// return - int: return 0 if all n characters are same in both string else return -1 
//               if first string is smaller than second else return 1.
